...
import {
  ...
  type StopThreadProviderTaskInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    stopProviderTask: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:stop-provider-task",
      execute: (input: StopThreadProviderTaskInput) => stopThreadProviderTask(input),
      scheduler,
      concurrency,
    }),
