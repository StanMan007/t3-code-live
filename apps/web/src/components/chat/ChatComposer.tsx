            ...
            <SelectTrigger
              ...
              className={cn(
                ...
                props.runtimeMode === "full-access" &&
                  "text-orange-500 hover:text-orange-400 dark:text-orange-400",
              )}
...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
    ...
    if (composerTrigger.kind === "slash-command") {
      const builtInSlashCommandItems = [
        ...
        },
        {
          ...
          command: "workflows",
          label: "/workflows",
          description: "Open Claude workflows for the current branch",
        },
  ...
  return (
    ...
    >
      <div
        className={cn("group rounded-[22px]", composerProviderState.composerFrameClassName)}
      ...
      >
        <div
          ...
          className={cn(
            "rounded-[20px] border-0 outline-none ring-0 transition-[background-color] duration-200 has-focus-visible:border-0 has-focus-visible:outline-none has-focus-visible:ring-0",
        ...
        >
          ...
          {isComposerCollapsedMobile ? null : activePendingApproval ? (
            ...
            <div
              ...
              className={cn(
                "flex min-w-0 flex-nowrap items-center justify-between gap-2 overflow-visible px-2 pb-2 sm:px-2.5 sm:pb-2.5",
